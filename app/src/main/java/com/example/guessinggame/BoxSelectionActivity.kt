...
import com.example.guessinggame.databinding.ActivityBoxSelectionBinding
import com.example.guessinggame.databinding.ItemBoxBinding
...
class BoxSelectionActivity : BaseActivity() {
    ...
    private fun onBoxSelected(view: View) {
        if (view.tag as Int == boxIndex) {
            ...
            Toast.makeText(this, R.string.empty_box, Toast.LENGTH_LONG).show()
        }
    }
